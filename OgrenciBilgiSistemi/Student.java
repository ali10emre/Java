...
public class Student {
    ...
    public void calcAvarage() {
        double fizikAvarage = 0;
        double kimyaAvarage = 0;
        double matAvarage = 0;

        fizikAvarage = (this.fizik.note * 0.8) + (this.fizik.verbalNote * 0.2 );
        kimyaAvarage = (this.kimya.note * 0.8) + (this.kimya.verbalNote * 0.2);
        matAvarage = (this.mat.note * 0.8) + (this.mat.verbalNote * 0.2);
